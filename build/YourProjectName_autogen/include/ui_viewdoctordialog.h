...
public:
    ...
    void setupUi(QDialog *ViewDoctorDialog)
    {
        ...
        ViewDoctorDialog->resize(800, 600);
        ...
        table_doctor->setGeometry(QRect(0, 90, 801, 511));
        ...
        btn_delete->setGeometry(QRect(690, 317, 85, 85));
...
"border-image: url(:/images/delete-icon.png);"));
        ...
        btn_edit->setGeometry(QRect(690, 410, 85, 85));
...
"border-image: url(:/images/icons/ic_arrow_back_white_48dp.png);"));
        ...
        btn_add->setGeometry(QRect(690, 506, 85, 85));
...
"border-image: url(:/images/add-icon.png);"));
        ...
        btn_view->setGeometry(QRect(690, 225, 85, 85));
...
"border-image: url(:/images/view-icon.png);"));
        ...
        snackbar->setGeometry(QRect(-1, 562, 810, 40));
