...
public:
    ...
    void setupUi(QDialog *EditPatientDialog)
    {
        ...
        EditPatientDialog->resize(800, 600);
...
"border: 1px solid #1976D2;border-radius:5px;"));
        ...
        frame->setGeometry(QRect(3, 70, 520, 420));
...
"border-radius:5px;"));
        ...
        label_7->setGeometry(QRect(333, 0, 160, 70));
        QFont font;
        ...
        frame_2->setGeometry(QRect(533, 70, 250, 420));
...
""));
        ...
        snackbar->setGeometry(QRect(-8, 570, 810, 40));
