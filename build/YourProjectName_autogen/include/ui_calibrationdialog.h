...
public:
    ...
    void setupUi(QDialog *CalibrationDialog)
    {
        ...
        CalibrationDialog->resize(800, 600);
        ...
        wm_plt->setGeometry(QRect(0, 200, 512, 255));
...
"background-image:url(empty.png);"));
        ...
        marker_cornea_2->setGeometry(QRect(0, 455, 510, 20));
...
""));
        ...
        lbl_avgAl->setGeometry(QRect(560, 90, 80, 30));
...
"border-image:url(empty.png);"));
        ...
        lineEdit_avgAl->setGeometry(QRect(640, 60, 130, 80));
        QFont font;
...
"color:rgb(21,21,21);"));
        ...
        btn_start->setGeometry(QRect(540, 470, 240, 70));
...
"border-radius:5px;"));
        ...
        btn_back->setGeometry(QRect(0, 0, 60, 60));
...
"border-image: url(:/images/backbutton.png);"));
        ...
        label->setGeometry(QRect(360, 10, 110, 40));
        QFont font1;
