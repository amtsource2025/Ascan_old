...
public:
    ...
    void setupUi(QDialog *ViewPatientDialog)
    {
        ...
        btn_view->setGeometry(QRect(1180, 270, 85, 85));
...
"border-image: url(:/images/view-icon.png);"));
        ...
        btn_delete->setGeometry(QRect(1180, 360, 85, 85));
...
"border-image: url(:/images/delete-icon.png);"));
        ...
        table_patient->setGeometry(QRect(10, 60, 1261, 601));
        table_patient->setStyleSheet(QString::fromUtf8("background-image:url(empty.png);"));
        table_patient->setEditTriggers(QAbstractItemView::EditTrigger::NoEditTriggers);
        table_patient->setColumnCount(7);
        ...
        btn_edit->setGeometry(QRect(1180, 450, 85, 85));
...
"border-image: url(:/images/edit-icon.png);"));
        ...
        label->setGeometry(QRect(560, 10, 160, 41));
        QFont font;
        ...
        btn_close->setGeometry(QRect(0, -10, 81, 71));
...
"border-image: url(:/images/icons/ic_arrow_back_white_48dp.png);"));
        ...
        btn_add->setGeometry(QRect(1180, 540, 85, 85));
