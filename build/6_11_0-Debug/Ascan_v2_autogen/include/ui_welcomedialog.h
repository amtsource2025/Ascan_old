...
"}"));
        ...
        comboBox_patientSelect->setEnabled(true);
        comboBox_patientSelect->setGeometry(QRect(340, 250, 541, 61));
        comboBox_patientSelect->setFont(font);
        comboBox_patientSelect->setAcceptDrops(false);
        comboBox_patientSelect->setStyleSheet(QString::fromUtf8("FixedComboBox {\n"
...
"    border-radius: 5px;\n"
"}"));
        comboBox_patientSelect->setEditable(true);
...
"background-image:url(empty.png);"));
        lbl_serialNumber->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
