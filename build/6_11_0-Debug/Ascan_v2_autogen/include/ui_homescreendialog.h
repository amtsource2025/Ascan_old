...
"background-image:url(empty.png)"));
        frame_sidebar->setFrameShape(QFrame::Shape::StyledPanel);
        frame_sidebar->setFrameShadow(QFrame::Shadow::Raised);
...
"border-image: url(:/images/view-icon.png);"));
        ...
        label->setGeometry(QRect(800, 640, 290, 30));
        QFont font1;
...
"background-image:url(empty.png);color:rgb(255,255,255);"));
        ...
        stackedWidget->setGeometry(QRect(540, 20, 671, 601));
...
"}"));
        ...
        btn_measure->setGeometry(QRect(530, 40, 100, 110));
...
"}"));
        ...
        lbl_measure->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"}"));
        ...
        lbl_print->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"}"));
        ...
        lbl_doctors->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"}"));
        ...
        lbl_patients->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"}"));
        ...
        lbl_settings->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"}"));
        ...
        lbl_calibrate->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"color:rgb(33,33,33);"));
        ...
        lbl_lenses_2->setAlignment(Qt::AlignmentFlag::AlignCenter);
        frame_sidebar->raise();
        stackedWidget->raise();
        label->raise();
        snackbar->raise();
