...
public:
    ...
    void setupUi(QMainWindow *WelcomeDialog)
    {
        ...
        btn_ascan->setGeometry(QRect(300, 30, 211, 151));
        btn_ascan->setStyleSheet(QString::fromUtf8("background-image:url(empty.png);\n"
"border-image: url(:/images/ascan-select.png);"));
        btn_ascan->setFlat(true);
        frame = new QFrame(centralWidget);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(60, 190, 691, 361));
...
"background-image:url(:/empty.png);"));
        ...
        btn_surgeon->setGeometry(QRect(30, 180, 110, 110));
...
"border-image: url(:/images/patient-icon.png);"));
        ...
        btn_enter->setGeometry(QRect(530, 320, 120, 40));
        QFont font;
        font.setPointSize(14);
        btn_enter->setFont(font);
        btn_enter->setStyleSheet(QString::fromUtf8("border-image:url(:/images/empty.png);\n"
"color: rgb(85, 87, 83);"));
        ...
        btn_newDoctor_2->setGeometry(QRect(400, 320, 130, 40));
        btn_newDoctor_2->setFont(font);
        btn_newDoctor_2->setStyleSheet(QString::fromUtf8("border-image:url(:/images/empty.png);\n"
"color: rgb(33, 150, 243);"));
        ...
        comboBox_patientSelect->setGeometry(QRect(160, 210, 471, 41));
        comboBox_patientSelect->setStyleSheet(QString::fromUtf8("border-image:url(empty.png);\n"
"background-image:url(empty.png);"));
        label = new QLabel(centralWidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(310, 170, 192, 17));
        ...
        lbl_time->setGeometry(QRect(680, -3, 120, 40));
        QFont font1;
        ...
        lbl_docName->setGeometry(QRect(2, 2, 250, 28));
...
"border-image:url(empty.png);"));
        ...
        lbl_softwareVersion->setGeometry(QRect(0, 570, 130, 28));
