...
public:
    ...
    void setupUi(QDialog *AddLensDialog)
    {
        ...
        lbl_title->setGeometry(QRect(330, -7, 160, 70));
        QFont font;
...
"border-image:url(empty.png);"));
        ...
        snackbar->setGeometry(QRect(-11, 563, 814, 40));
...
"color:rgb(255,255,255);"));
        ...
        frame->setGeometry(QRect(6, 63, 780, 420));
...
""));
        ...
        comboBox_lensType->setStyleSheet(QString::fromUtf8("background-image:url(:/images/empty.png);\n"
"border-image:url(:/images/empty.png);\n"
""));
