...
"border-radius:5px;"));
        ...
        snackbar->setGeometry(QRect(-11, 570, 814, 40));
...
"border: 1px solid #1976D2;border-radius:5px;"));
        ...
        frame->setGeometry(QRect(6, 70, 780, 420));
...
""));
        ...
        comboBox_lensType->setStyleSheet(QString::fromUtf8("background-image:url(empty.png);\n"
"border-image:url(empty.png);\n"
""));
...
""));
        ...
        lbl_title->setGeometry(QRect(330, 0, 160, 70));
        QFont font;
