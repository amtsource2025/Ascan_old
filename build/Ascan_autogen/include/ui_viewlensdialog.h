...
public:
    ...
    void setupUi(QDialog *ViewLensDialog)
    {
        ...
        btn_add->setGeometry(QRect(690, 509, 85, 85));
...
"border-image: url(:/images/add-icon.png);"));
        ...
        btn_delete->setGeometry(QRect(690, 320, 85, 85));
...
"border-image: url(:/images/delete-icon.png);"));
        ...
        btn_edit->setGeometry(QRect(690, 413, 85, 85));
...
"border-image: url(:/images/edit-icon.png);"));
        ...
        btn_close->setGeometry(QRect(0, 3, 70, 60));
...
"border-image: url(:/images/icons/ic_arrow_back_white_48dp.png);"));
        ...
        table_lenses->setGeometry(QRect(0, 93, 801, 511));
        ...
        lbl_lenses->setGeometry(QRect(340, 3, 160, 70));
        QFont font;
