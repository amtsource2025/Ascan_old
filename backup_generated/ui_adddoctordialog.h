...
"border-radius:5px;"));
        ...
        btn_cancel->setGeometry(QRect(1060, 590, 202, 65));
...
"border: 1px solid #1976D2;border-radius:5px;"));
        ...
        frame->setGeometry(QRect(10, 70, 1251, 491));
...
"}"));
        ...
        lineEdit_docName->setGeometry(QRect(210, 50, 390, 30));
        lineEdit_docName->setStyleSheet(QString::fromUtf8("background:rgb(255,255,255);"));
        comboBox_lensPresetOne = new QComboBox(frame);
        comboBox_lensPresetOne->setObjectName(QString::fromUtf8("comboBox_lensPresetOne"));
        comboBox_lensPresetOne->setGeometry(QRect(210, 130, 260, 27));
        ...
        comboBox_lensPresetTwo->setGeometry(QRect(210, 200, 260, 27));
        ...
        comboBox_lensPresetThree->setGeometry(QRect(210, 290, 260, 27));
        ...
        comboBox_primaryFormula->setGeometry(QRect(210, 370, 260, 27));
...
"color:rgb(255,255,255);"));
        ...
        snackbar->setGeometry(QRect(0, 660, 1281, 40));
