...
"background-image:url(:/images/empty.png);"));
        ...
        btn_no->setGeometry(QRect(130, 190, 80, 40));
        btn_no->setStyleSheet(QString::fromUtf8("background-image:url(:/images/empty.png);border-image:url(:/images/empty.png);"));
        btn_no->setFlat(true);
        btn_yes = new QPushButton(PromptDialog);
        btn_yes->setObjectName(QString::fromUtf8("btn_yes"));
        btn_yes->setGeometry(QRect(220, 190, 80, 40));
        btn_yes->setStyleSheet(QString::fromUtf8("background-image:url(:/images/empty.png);border-image:url(:/images/empty.png);"));
        btn_yes->setFlat(true);
        label = new QLabel(PromptDialog);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(30, 30, 250, 71));
        QFont font;
        font.setPointSize(14);
        label->setFont(font);
        label->setStyleSheet(QString::fromUtf8("background-image:url(:/images/empty.png);border-image:url(:/images/empty.png);"));
        label->setWordWrap(true);
        label_2 = new QLabel(PromptDialog);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(30, 100, 325, 30));
        label_2->setStyleSheet(QString::fromUtf8("background-image:url(:/images/empty.png);border-image:url(:/images/empty.png);"));
